...
//             const res = await axios.get(`http://localhost:8000/api/v1/exams/getExamsById/${id}`, {
//                 headers: {
...
//                     <h2>{exams.title}</h2>
//                     <h2>{exams.subject}</h2>
//                     <h2>{exams.duration}</h2>
//                     <h2>{exams.description}</h2>
//                     <h2>{exams.totalMarks}</h2>
//                     <h2>{exams.passingMarks}</h2>
//                     <h2>{exams.startTime}</h2>
//                     <h2>{exams.endTime}</h2>
//                 </>
//             ):
